"""
URL configuration for web_loja project.
...
Function views
    ...
    2. Add a URL to urlpatterns:  path('v1/', views.home, name='home')
Class-based views
    1. Add an import:  from other_app.views import Home
    2. Add a URL to urlpatterns:  path('v1/', Home.as_view(), name='home')
Including another URLconf
    1. Import the include() function: from django.urls import include, path
    2. Add a URL to urlpatterns:  path('v1/blog/', include('blog.urls'))
"""
